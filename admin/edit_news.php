        ...
        <div class="right">
            ...
            <form method="POST" action="">
                <div class="input-container">
                    ...
                    <input type="text" class="input-field" id="title" name="title" placeholder="Title" value="<?php echo $existingnews['title']; ?>">
                </div>
                <div class="input-container">
                    <i class="fas fa-lock"></i>
                    <input type="text" class="input-field" id="content" name="content" placeholder="Content" value="<?php echo $existingnews['content']; ?>">
                </div>
