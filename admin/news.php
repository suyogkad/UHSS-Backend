...
<html lang="en">
  ...
  <h1 class="page-title">Latest News</h1>
    <div class="container mt-4">
      ...
      foreach ($allNews as $news): ?>
        <div class="news-item">
          ...
          <p>Publish Date: <?php echo $news['publishedDate'] ?></p>
          <div class="actions">
    ...
    <script>
      document.querySelectorAll('.delete-news').forEach(function(deleteButton) {
        deleteButton.addEventListener('click', function(event) {
          event.preventDefault();
          var newsTitle = event.target.getAttribute('data-title');
          var confirmation = confirm("Do you want to delete this news: " + newsTitle + "?");
          if (confirmation) {
