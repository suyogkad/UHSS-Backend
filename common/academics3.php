  ...
  <body>
    ...
    <section class="navigation">
      ...
      <div class="academics-II">
        <div class="column-1">
          <h1 class="school-name">Pioneer Int'l College</h1>
          <p>
            Welcome to Pioneer International College. Pioneer Int'l College
            offers you BBM and BBA courses.
          </p>
          <a
            class="apply-button"
        ...
        <div class="column-2">
          <h1 class="school-name">
            <a class="course-button" role="button" href="../common/bbs.php"
              >BBS</a
            >
          </h1>

          <h1 class="school-name">
            <a class="features-button" role="button" href="../common/bbm.php"
              >BBM</a
            >
          </h1>
        </div>
      ...
      <div class="academics-II-content">
        <h1 class="u2-features2">Admission Criteria</h1>
        <ul>
          <li>
            If you have completed the twelve years of schooling or its
            equivalent from any board, institution recognized by Tribhuvan
            University.
          </li>
          <li>
            If you have secured at least the second division in the +2 or D+ in
            the GPA system or only the Second Div. in the PCL level.
          </li>
          <li>
            If you have scored at least 40% marks in the CMAT(Central Management
            Admission Test) conducted by Tribhuvan University.
          </li>
        </ul>
        <br />
        <h1 class="u2-features2">Attendance</h1>
        <p>
          Regularity is one of the mandatory criteria of the BBM programme.
          Students are supposed to be regular, punctual, dedicated, diligent and
          disciplined to attain the maximum benefit. It is the course in which
          contents are so linked with each other that if students miss some of
          the classes and/or are negligent, they may not be able to meet the set
          criteria. Therefore, at least 80% attendance is a must for the win-win
          environment.
        </p>
        <!-- <h1 class="u2-features1">Non-Credit Courses and Activities</h1>
          <hr class="heading-hr" />
          <p>In order to offer versatility and dynamism, we offer students computer, meditation and Yoga courses. Project-work, guest lecture, seminars, workshops, presentation, simulation and so on are our inherent activities. For the development of more skills of the students non-credit classes are offered to develop skills like:
            <ul>
