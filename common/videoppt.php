  ...
  <body>
    ...
    <div>
      <div class="video-main">
        <h1 class="school-name">Recent PPT (PowerPoint Presentation)</h1>
        <p>Published Date: 2022/04/16</p>
        <h4>Parent-School Interaction (PSI) Slides.</h4>
        <div class="presentation">
          <a
            href="https://docs.google.com/presentation/d/14NCqWqLWNbQTOmaPTDYT-QDFMs9rUH-h/edit?usp=sharing&ouid=111888108727868125698&rtpof=true&sd=true"
            target="_blank"
            >View
          </a>
          <div class="download">
            <a
              href="https://drive.google.com/uc?export=download&id=14NCqWqLWNbQTOmaPTDYT-QDFMs9rUH-h"
              target="_blank"
              >Download
            </a>
          </div>
        ...
        <br />
        <div class="video-main">
          <h1 class="school-name">Video Recommendation</h1>
          <h4>
            Title: Maria Montessori - The Absorbent Mind - Children Through Age
            ...
            target="_blank"
          >
            <button class="btn-view" role="button">View</button>
          </a>
          <a
            href="https://drive.google.com/uc?export=download&id=14NCqWqLWNbQTOmaPTDYT-QDFMs9rUH-h"
            target="_blank"
          >
            <button class="btn-download" role="button">Download</button>
          </a> -->
          </h4>
          <div class="vid-container">
            <iframe
              width="454"
              height="371"
              src="https://www.youtube.com/embed/pcI_7W-3XYQ"
